...
function whiteboard_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary Menu', 'whiteboard' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'whiteboard_custom_background_args', array(
		'default-color' => 'ffffff',
		'default-image' => '',
	) ) );
}
endif; // whiteboard_setup
...
function whiteboard_scripts() {
	...
	wp_enqueue_script( 'whiteboard-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'whiteboard-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
...
function field_status_post_type() {
	...
	$args = array(
		...
		'description'           => __( 'Field Stauts', 'text_domain' ),
		'labels'                => $labels,
...
add_action( 'init', 'field_status_post_type', 0 );
