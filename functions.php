...
function whiteboard_scripts() {
  ...
  // scripts
  wp_enqueue_script( 'whiteboard-jquery', get_template_directory_uri() . '/js/vendors/jquery/jquery.js', array(), '20130115', true );
  wp_enqueue_script( 'whiteboard-lodash', get_template_directory_uri() . '/js/vendors/lodash/lodash.js', array(), '20130115', true );
  // endscripts
